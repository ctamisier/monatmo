...
watch(currentPos, (cur) => {
  if (pendingTarget.value !== null && Math.abs(cur - pendingTarget.value) < 1) {
    ...
    <div class="card-body text-center">
      ...
      <div class="flex items-start justify-between w-full gap-4">
        <div class="flex flex-col items-center flex-1">
          <button
            class="btn-open shutter-btn-top"
            @click="onOpen"
          >
            ▲ {{ t('shutter.open') }}
          </button>
          ...
          <button
            class="btn-close shutter-btn-bottom"
            @click="onClose"
          >
            ▼ {{ t('shutter.close') }}
          </button>
