...
<template>
  <div class="card-custom">
    <div class="card-body">
      ...
      <div
        v-if="light.lightModules.length === 0"
...
<style scoped>
.card-inner.light-on {
  background: radial-gradient(ellipse 120% 80% at 50% 30%, rgba(240, 192, 64, 0.10) 0%, rgba(244, 132, 95, 0.05) 40%, rgba(10, 8, 20, 0.97) 80%);
  box-shadow: 0 0 30px rgba(240, 192, 64, 0.15);
}

.card-inner.light-on:hover {
  background: radial-gradient(ellipse 120% 80% at 50% 30%, rgba(240, 192, 64, 0.12) 0%, rgba(244, 132, 95, 0.06) 40%, rgba(10, 8, 20, 0.97) 80%);
